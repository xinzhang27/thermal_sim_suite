...
p.generateBottomUpExtrudedMesh(cell=c[0],
    ...
    targetSide=pickedGeomTargetSide, numberOfLayers=20)
...
pickedElemFaces = e.getSequenceFromMask(mask=(
    '[#20202020:5 #0:45 #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5',
    ' #0:45 #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5 #0:45',
    ' #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5',
    ' #0:45 #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5 #0:45',
    ' #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5 #0:45 #20202020:5',
    ' #0:45 #20202020:5 #0:45 #20202020:5 ]',), )
f1 = p.faces
...
e = p.elementFaces
pickedElemFaces = e.getSequenceFromMask(mask=(
    '[#0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45',
    ' #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5',
    ' #0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45',
    ' #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5',
    ' #0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45',
    ' #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 ]',), )
f1 = p.faces
...
p = mdb.models['Model-1'].parts['Part-1']
e = p.elementFaces
pickedElemFaces = e.getSequenceFromMask(mask=('[#0:950 #2020202:50 ]',), )
f1 = p.faces
...
pickedElemFaces = e.getSequenceFromMask(mask=(
    ...
    ' #0:45 #20202020:5 #0:45 #20202020:5 ]',), )
f = p.faces
p.associateMeshWithGeometry(geometricEntity=f[4], elemFaces=pickedElemFaces)
p = mdb.models['Model-1'].parts['Part-2']
e = p.elementFaces
pickedElemFaces = e.getSequenceFromMask(mask=(
    '[#0:4 #10000000 #0:4 #10000000 #0:4 #10000000 #0:4',
...
f1 = p.faces
p.associateMeshWithGeometry(geometricEntity=f1[0], elemFaces=pickedElemFaces)
p = mdb.models['Model-1'].parts['Part-2']
e = p.elementFaces
pickedElemFaces = e.getSequenceFromMask(mask=(
    '[#0:45 #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 #0:45',
    ...
    ' #8080808:5 #0:45 #8080808:5 #0:45 #8080808:5 ]',), )
f = p.faces
p.associateMeshWithGeometry(geometricEntity=f[5], elemFaces=pickedElemFaces)
p = mdb.models['Model-1'].parts['Part-2']
e = p.elementFaces
pickedElemFaces = e.getSequenceFromMask(mask=('[#4 #0:4 #4 #0:4 #4 #0:4 #4',
                                              ' #0:4 #4 #0:4 #4 #0:4 #4 #0:4', ' #4 #0:4 #4 #0:4 #4 #0:4 #4',
